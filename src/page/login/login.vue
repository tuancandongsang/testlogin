<template>
    <div class="container">
        <div class="login-form">
            ...
            <button class="login-form-btn" @click="handleSubmit">{{ $tc('login') }}</button>
            <p class="login-form-message-error" v-if="messageError">Please check information...</p>
            <p class="login-form-message-success" v-if="messageSuccess">Login Success...</p>
